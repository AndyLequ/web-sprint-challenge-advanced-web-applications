  ...
  const login = ({ username, password }) => {
    ...
    axios.post(loginUrl, {username, password})
      ...
      .catch(err => {
        ...
        setMessage(responseMessage || `Something horrible logging in: ${err.message}`)
      })
      .finally(() => {
        setSpinnerOn(false)
      })
      ...
      <div id="wrapper" style={{ opacity: spinnerOn ? "0.25" : "1" }}> {/* <-- do not change this line */}
        ...
        <Routes>
          ...
          <Route path="articles" element={
            <>
              <ArticleForm postArticle={postArticle} updateArticle={updateArticle} currentArticle={articles.find(art => art.article_id == currentArticleId)} setCurrentArticleId={setCurrentArticleId}/>
